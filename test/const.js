...
var filePath = (function() {
  ...
  result =
    result.length > min && !/test(?:\.js)?$/.test(last) ? last : '../node_modules/lodash/lodash.js';
...
(function() {
  ...
  setProperty(objectProto, 'propertyIsEnumerable', function(key) {
    return (
      // eslint-disable-next-line eqeqeq
      !(key == 'valueOf' && this && this.valueOf === 1) && _propertyIsEnumerable.call(this, key)
    );
  });
...
lodashStable.attempt(function() {
  ...
  if (isModularize && !(amd || isNpm)) {
    lodashStable.each(['baseEach', 'isIndex', 'isIterateeCall', 'memoizeCapped'], function(
      funcName
    ) {
